<?php
class appJson extends CI_Controller {
    ...
    */
    public function __construct()
    {
        ...
        /*$json = file_get_contents('https://drive.google.com/file/d/0B8NYMqSaJBAmdmpZYVBIdzlHVEk/view');
    ...
    */
    ...
    {
        /*$data["listaDevelopers"] = $this->developers_model->getData();
        //load the view
        ...
        if($search_string !== false )
        {
            ...
            if($search_string) {
                $data['listaDevelopers'] = $this->developers_model->getData($search_string);
            }
            else{
                $data['listaDevelopers'] = $this->developers_model->getData('');
            }
